...
static clog_level_t clog_min_level = CLOG_INFO;
static clog_color_mode_t clog_color_mode = CLOG_COLOR_AUTO;
static FILE *clog_output = NULL; /* NULL means stderr */
static bool clog_show_timestamp = true;
static bool clog_show_location = false;
...
static void clog_safe_write(const char *str, size_t len) {
  FILE *output = clog_output ? clog_output : stderr;
#if CLOG_WINDOWS
